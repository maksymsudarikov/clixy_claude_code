        ...
        <div className="mt-20 pt-12 border-t-2 border-[#141413] text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              className="inline-block border-2 border-[#141413] px-8 py-4 text-xs font-bold uppercase tracking-widest hover:bg-[#141413] hover:text-white transition-colors"
            >
              Contact Us
            </a>
          </div>
