...
Были выполнены 4 критичных исправления безопасности:

1. ✅ **RLS Policies в Supabase** - SQL скрипт готов
2. ✅ **Hardcoded токены** - Удалены из constants.ts
3. ✅ **MD5 → bcrypt** - PIN хэширование обновлено
4. ⏳ **Sentry monitoring** - Инструкция ниже
...
- [ ] **1. Запустить SQL скрипт в Supabase** (supabase-fix-rls-policies.sql)
- [ ] **2. Обновить VITE_ADMIN_PIN_HASH в .env.local** (новый bcrypt hash)
